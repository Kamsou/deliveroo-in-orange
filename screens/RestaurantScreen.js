  ...
  return (
    <>
        ...
        <View className="relative">
            ...
            >
                <ArrowLeftIcon color="#F27405" size={20} />
            </TouchableOpacity>
        </View>
        ...
        <View className="bg-white">
            <View className="px-4 pt-4">
                ...
                <View className="flex-row items-center space-x-1">
                    <StarIcon color="#F27405" opacity={0.5} size={22} />
                    <Text className="text-xs text-gray-500">
                        <Text className="text-xs text-[#F27405]">{rating}</Text> • {genre}
                    </Text>
                </View>
            ...
            <TouchableOpacity className="flex-row items-center space-x-2 p-4 border-y border-gray-300">
                <QuestionMarkCircleIcon color="#F27405" opacity={0.6} size={20} />
                <Text className="pl-2 flex-1 text-md font-bold">Have a food allergy?</Text>
                <ChevronRightIcon color="#F27405" />
            </TouchableOpacity>
        </View>
